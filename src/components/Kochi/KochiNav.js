    ...
    <div className="flex justify-center mt-20 mb-24">
      <div>
        <div className="text-center">
          ...
          <h1 className="uppercase dark:text-white text-5xl leading-normal text-gray-800">Kochi<span className="text-k-orange">pad</span></h1>
        ...
        <div className="text-center max-w-2xl mt-20">
          ...
          <span className="dark:text-gray-300 text-xl pt-5 block text-gray-800">Launch your token with Kochi. All fees are shared among Kochi token and NFT stakers.</span>
