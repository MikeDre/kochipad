...
function BrowsePresale() {
  return (
    <>
      ...
      <div class="mb-8 text-black dark:text-gray-300 max-w-screen-md">
      ...
      <div className="grid gap-6 mb-8 md:grid-cols-3">
        <Card>
          ...
          <CardBody class="text-center min-w-0 rounded-b-lg shadow-xs overflow-hidden bg-white dark:bg-gray-800 border border-gray-600 p-5">
